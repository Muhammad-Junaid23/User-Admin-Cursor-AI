...
const INITIAL_DATA: CategoryMap = {
  Pharmacy: {
    ...
    Antibiotics: [{ id: 'P-101', name: 'Amoxicillin 500mg', category: 'Pharmacy', subCategory: 'Antibiotics', price: 84, quantity: 40 }],
    Vitamins: [{ id: 'P-201', name: 'Vitamin C 1000mg', category: 'Pharmacy', subCategory: 'Vitamins', price: 59, quantity: 65 }],
  },
  Grocery: {
    Beverages: [
    ...
    Snacks: [{ id: 'G-101', name: 'Potato Chips 150g', category: 'Grocery', subCategory: 'Snacks', price: 12, quantity: 200 }],
    Dairy: [{ id: 'G-201', name: 'Whole Milk 1L', category: 'Grocery', subCategory: 'Dairy', price: 15, quantity: 90 }],
  },
};
...
function EditItemModal({ item, onClose, onSave }: { item?: InventoryItem; onClose: () => void; onSave: (item: InventoryItem) => void }) {
